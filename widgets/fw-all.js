...
WidgetMetadata={id:"hyj1817.missav.home",title:"MissAV",icon:"https://missav.live/favicon.ico",version:"1.0.0",requiredVersion:"0.0.1",description:"MissAV 首页、分类、搜索与详情",author:"Forward Widgets",site:"https://missav.live",modules:[{id:"latest",title:"最近更新",functionName:"loadLatest",type:"url",cacheDuration:600,params:[]},{id:"release",title:"新作上市",functionName:"loadRelease",type:"url",cacheDuration:600,params:[]},{id:"uncensored",title:"无码流出",functionName:"loadUncensored",type:"url",cacheDuration:600,params:[]},{id:"subtitle",title:"中文字幕",functionName:"loadSubtitle",type:"url",cacheDuration:600,params:[]},{id:"actresses",title:"女优筛选",functionName:"loadActresses",type:"url",cacheDuration:600,params:[{name:"cup",title:"罩杯",type:"input",value:"H"},{name:"age",title:"年龄",type:"input",value:"20-30"}]}],search:{title:"搜索",functionName:"search",params:[{name:"keyword",title:"关键词",type:"input"}]}};
...
function out(a){return a.map(function(x){var slug=x.url.split("missav.live/")[1]||x.url;return {id:"missav:"+slug,type:"url",title:x.title,seriesName:x.title,description:x.title,mediaType:"movie",link:"missav:"+slug};})}
