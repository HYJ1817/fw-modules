/* Generated by scripts/build-fw-trace.js. Independent diagnostic copy; do not edit directly. */

var WidgetMetadata = {
  "id": "hyj1817.fw.trace",
  "title": "FW 总模块·诊断副本",
  "description": "独立副本：从此模块首页复现，再测试“诊断：读取记录”。不替换原版。",
  "author": "HYJ1817",
...
var Widget = fwtHost("FW_HSTREAM_HOME");
var console = fwtConsole("FW_HSTREAM_HOME");
var WidgetMetadata;
/**
...
var Widget = fwtHost("FW_YIN_HOME");
var console = fwtConsole("FW_YIN_HOME");
var WidgetMetadata;
...
var Widget = fwtHost("FW_HANIME_HOME");
var console = fwtConsole("FW_HANIME_HOME");
var WidgetMetadata;
...
var Widget = fwtHost("FW_HSTREAM_RESOURCE");
var console = fwtConsole("FW_HSTREAM_RESOURCE");
var WidgetMetadata;
/**
...
var Widget = fwtHost("FW_YIN_RESOURCE");
var console = fwtConsole("FW_YIN_RESOURCE");
var WidgetMetadata;
...
var Widget = fwtHost("FW_HANIME_RESOURCE");
var console = fwtConsole("FW_HANIME_RESOURCE");
var WidgetMetadata;
...
var Widget = fwtHost("FW_4KVM_RESOURCE");
var console = fwtConsole("FW_4KVM_RESOURCE");
var WidgetMetadata;
...
hstream_loadLatest = fwtWrap("hstream_loadLatest", hstream_loadLatest);
hstream_loadRecent = fwtWrap("hstream_loadRecent", hstream_loadRecent);
hstream_loadPopular = fwtWrap("hstream_loadPopular", hstream_loadPopular);
hstream_loadCategory = fwtWrap("hstream_loadCategory", hstream_loadCategory);
yin_loadLatest = fwtWrap("yin_loadLatest", yin_loadLatest);
yin_loadUpdated = fwtWrap("yin_loadUpdated", yin_loadUpdated);
yin_loadPopular = fwtWrap("yin_loadPopular", yin_loadPopular);
yin_loadCategory = fwtWrap("yin_loadCategory", yin_loadCategory);
hanime_loadRecent = fwtWrap("hanime_loadRecent", hanime_loadRecent);
hanime_loadNew = fwtWrap("hanime_loadNew", hanime_loadNew);
hanime_loadTrending = fwtWrap("hanime_loadTrending", hanime_loadTrending);
hanime_loadRandom = fwtWrap("hanime_loadRandom", hanime_loadRandom);
hanime_loadCategory = fwtWrap("hanime_loadCategory", hanime_loadCategory);
loadResource = fwtWrap("loadResource", loadResource);
searchAll = fwtWrap("searchAll", searchAll);
loadDetail = fwtWrap("loadDetail", loadDetail);
